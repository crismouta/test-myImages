    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/images/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/users/login").hasAnyAuthority("ROLE_admin", "ROLE_user")
